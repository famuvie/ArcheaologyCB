...
res.df.foodremains <- data.frame(loc, 
                        method = c(rep('Classical', nrow(loc)),
                                   rep('Cost-based', nrow(loc)),
                                   rep('Difference', nrow(loc))),
...
p.foodremains <- 
  ggplot(filter(res.df.foodremains, method != 'Difference'),
         aes(x, y)) + 
  geom_raster(aes(fill = Prediction, colour = Prediction)) +
  stat_contour(aes(z = Prediction), binwidth = .5, color = 'lightgray') +
  geom_india() +
...
```{r foodremains-map-kriging-difference, fig.width=10, fig.height=6, fig.cap='Difference between the Euclidean and the cost-based predictions.'}
...
res.var.foodremains <- data.frame(loc, 
                        method = c(rep('Classical', nrow(loc)),
                                   rep('Cost-based', nrow(loc)),
                                   rep('Difference', nrow(loc))),
                        Prediction = c(kriging.std.foodremains$krige.var,
                                          kriging.cst.foodremains$krige.var,
                                          kriging.std.foodremains$krige.var-kriging.cst.foodremains$krige.var))

ggplot(filter(res.var.foodremains, method != 'Difference'),
         aes(x, y)) + 
  geom_raster(aes(fill = Prediction, colour = Prediction)) +
  stat_contour(aes(z = Prediction), binwidth = .5, color = 'lightgray') +
  geom_india() +
...
```{r foodremains-map-kriging-difference-errors, fig.width=10, fig.height=6, fig.cap='Difference between the Euclidean and the cost-based prediction errors'}
