...
variable <- obs.gd$data[, 'foodremains']
```
...
## compute euclidean (only) variogram
vg.std.foodremains <- variog(obs.gd, data = variable)
...
## compute cost-based empirical variogram
vg.cst.foodremains <- variog(obs.gd, data = variable, dists.mat = ddm$obs)
...
variable <- obs.gd$data[, 'livingroom']
```
...
## compute euclidean (only) variogram
vg.std.livingroom <- variog(obs.gd, data = variable)
...
## compute cost-based empirical variogram
vg.cst.livingroom <- variog(obs.gd, data = variable, dists.mat = ddm$obs)
...
variable <- obs.gd$data[, 'enclosedspaces']
```
...
## compute euclidean (only) variogram
vg.std.enclosedspaces <- variog(obs.gd, data = variable)
...
## compute cost-based empirical variogram
vg.cst.enclosedspaces <- variog(obs.gd, data = variable, dists.mat = ddm$obs)
...
variable <- obs.gd$data[, 'burningareas']
```
...
## compute euclidean (only) variogram
vg.std.burningareas <- variog(obs.gd, data = variable)
...
## compute cost-based empirical variogram
vg.cst.burningareas <- variog(obs.gd, data = variable, dists.mat = ddm$obs)
...
## compute euclidean (only) variogram
vg.std.ashes <- variog(obs.gd, data = variable)
...
## compute cost-based empirical variogram
vg.cst.ashes <- variog(obs.gd, data = variable, dists.mat = ddm$obs)
